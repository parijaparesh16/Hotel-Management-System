...
class RoomBooking:
    def __init__(self, root):   # ✅ Proper __init__
        ...
        # =================logo=======================
        try:
            img2 = Image.open(r"C:\Users\ultro\Desktop\Hotel-Management-System-main\hotel images\logohotel.png")
        ...
        comboMeal["values"] = ("Room only", "Breakfast", "Half Board", "Full Board")
        comboMeal.current(0)
        comboMeal.grid(row=5, column=1)
        ...
        # ====================Right Side Image=====================
        try:
            img3 = Image.open(r"C:\Users\ultro\Desktop\Hotel-Management-System-main\hotel images\bed.jpg")
    ...
    def total(self):
        ...
        room_cost_per_day = room_prices.get(self.var_room_type.get(), 0.0)
        meal_cost_per_day = meal_prices.get(self.var_meal.get(), 0.0)
